...
import { School, Home, Search, MapPin, Navigation, Globe, CheckCircle ,X} from "lucide-react";
...
const SchoolForm = ({ onClose }) => {
  ...
  return (
      ...
      <button
        onClick={onClose}
        className="absolute hover:cursor-pointer top-10 right-7 text-gray-500 hover:text-red-500 transition"
      >
        <X className="w-6 h-6" />
      </button>
